...
iotop
```
When the network logger is successfully configured and running, data from the sensor will be transmitted to the central CORIOLIX system. Proceed to [Step 5: Data Logger Setup](HT_sensor_onboard_step5.md).

## Navigation

- **Previous:** [Step 3: Upload Calibration Files](HT_sensor_onboard_step3.md)
- **Next:** [Step 5: Data Logger Setup](HT_sensor_onboard_step5.md)
