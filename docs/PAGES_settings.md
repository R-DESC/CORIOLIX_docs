...
The Account Management page provides information on creating and managing CORIOLIX user accounts, including restricted content, user scope, alerts, and administrative controls.
...
#### Accessing Administrative Account Management
...
### Administrative Account Management Best Practices
