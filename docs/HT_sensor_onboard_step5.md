# Step 5: Data Logger Setup

This final step establishes the central data logger that receives network data from Step 4, processes it according to the sensor configuration, and stores it in the CORIOLIX database.

>[!NOTE]
>Prerequisites
>- Sensor record created (Step 1)
>- Parameters configured (Step 2)
>- Calibration files uploaded (Step 3)
>- Network logger running (Step 4)
...
- **Network Input**
  ...
  - Source Port: Configured in Step 4
  - Protocol: UDP or TCP
  - Buffer settings
...
- **Previous:** [Step 4: Network Logger Setup](HT_sensor_onboard_step4.md)
